        ...
        <div class="d-flex align-items-center w-100">
            ...
            <div class="d-flex align-items-center d-xl-none">
                <a class="navbar-brand" href="index.html">
                    <img class="light-mode-item navbar-brand-item h-30px" src="" alt="">
                    <img class="dark-mode-item navbar-brand-item h-30px" src="" alt="">
                </a>
            </div>
            <!-- Logo END -->
                            ...
                            <div class="card bg-transparent">
                                <div
                                    ...
                                    <h6 class="m-0">پیام ها <span
                                            class="badge bg-danger bg-opacity-10 text-danger ms-2">2 پیام
                                            جدید</span></h6>
                                            ...
                                            <a href="#"
                                                ...
                                                <div>
                                                    <p class="text-body small m-0">به <b> مهرداد قربانی </b>
                                                        برای
                                                        فارغ التحصیلی از <b>دانشگاه دماوند </b>تبریک
                                                        میگوییم.</p>
                    ...
                    <li class="nav-item ms-3 dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3"
                            ...
                            <li><a class="dropdown-item" href="#"><i
                                        class="bi bi-person fa-fw me-2"></i>ویرایش</a></li>
                            <li><a class="dropdown-item" href="#"><i
