...
<body>
                    ...
                    <ul class="navbar-nav navbar-nav-scroll me-auto">
                        ...
                        <li class="nav-item dropdown dropdown-menu-shadow-stacked">
                            <a class="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0"
                                ...
                                aria-expanded="false"><i class="bi bi-ui-radios-grid me-2"></i><span>دسته
                                    بندی</span></a>
                                        ...
                                        <div class="row p-4">
                                            ...
                                            <div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li> <a class="dropdown-item" href="#">اینستاگرام
                                                            مارکتینگ</a> </li>
                                                    <li> <a class="dropdown-item" href="#">تبلیغ نویسی</a> </li>
                                                    <li> <a class="dropdown-item" href="#">سرچ کنسول</a> </li>
                                                    <li> <a class="dropdown-item" href="#">جذب ترافیک موثر</a>
                                                    </li>
                                                    <li> <a class="dropdown-item" href="#">افزایش فروش</a> </li>
                                                    <li> <a class="dropdown-item" href="#">ویدیو مارکتینگ</a>
                                                    </li>
                                                    <li> <a class="dropdown-item" href="#">آموزش GTmetrix</a>
                                                    </li>
                                                    <li> <a class="dropdown-item" href="#">آموزش Alex</a> </li>
                                                    <li> <a class="dropdown-item" href="#">استراتژی تولید
                                                            محتوا</a> </li>
                                                    <li> <a class="dropdown-item" href="#">سئو و بهینه سازی</a>
                                                    </li>
                                                    <li> <a class="dropdown-item" href="#">اصول قرارداد
                                                            نویسی</a> </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
                                                ...
                                                <div class="d-flex mb-4 position-relative">
                                                    <img src="assets/images/client/uni-logo-01.svg" class="icon-md"
                                                        alt="">
                                                    <div class="ms-3">
                                                        <a class="stretched-link h6 mb-0 fw-normal" href="#">مدرک بین
                                                            المللی سطح مبتدی</a>
                                                ...
                                                <div class="d-flex position-relative">
                                                    ...
                                                    <div class="ms-3">
                                                        <a class="stretched-link h6 mb-0 fw-normal" href="#">مدرک بین
                                                            المللی سطح پیشرفته</a>
                                                        <p class="mb-0 small">کارشناسی ارشد توسعه کسب و کار دیجیتالی
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-xxl-4">
                                                ...
                                                <div class="d-flex mb-4 position-relative">
                                                    ...
                                                    <div class="ms-2">
                                                        <a class="stretched-link h6 mb-0 fw-normal" href="#">گواهی سئو
                                                            گوگل</a>
                                                ...
                                                <div class="d-flex mb-4 position-relative">
                                                    ...
                                                    <div class="ms-2">
                                                        <a class="stretched-link h6 mb-0 fw-normal" href="#">مدیر توسعه
                                                            کسب و کار (BDE)</a>
                                                        <p class="mb-0 small">بدون پیش نیاز</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex mb-4 position-relative">
                                                    ...
                                                    <div class="ms-2">
                                                        <a class="stretched-link h6 mb-0 fw-normal" href="#">بازاریابی
                                                            شبکه های اجتماعی فیس بوک</a>
                                                ...
                                                <div class="d-flex mb-4 position-relative">
                                                    ...
                                                    <div class="ms-2">
                                                        <a class="stretched-link h6 mb-0 fw-normal" href="#">طراحی
                                                            گرافیکی خلاقانه</a>
                                                        <p class="mb-0 small">بدون پیش نیاز</p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="card bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden"
                                                    ...
                                                    <div class="card-body">
                                                        <!-- Title -->
                                                        <h5 class="card-title text-white mb-2">دسترسی به 25 هزار دوره
                                                            آنلاین از 120 موسسه، از امروز شروع کنید!</h5>
                                                        <p class="text-white text-opacity-75">در اینجا توضیحاتی در مورد
                                                            ویژگی های برتر ارائه شده است که به کاربران امکان می دهد از
                                                            مزایایی برخوردار شوند و در هزینه های زیادی صرفه جویی کنند
                                                        </p>
                                                        <!-- Button -->
                                                        <a href="#" class="btn btn-sm btn-dark mb-0">خرید حرفه
                                                            ای</a>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <ul class="navbar-nav navbar-nav-scroll me-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle active" href="#" id="demoMenu" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">صفحه اصلی</a>
                            <ul class="dropdown-menu" aria-labelledby="demoMenu">
                                ...
                                <li> <a class="dropdown-item" href="index-9.html">نسخه 9</a>
                                <li>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="course-detail-min.html">جزئیات نسخه 2</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="course-detail-adv.html">جزئیات نسخه 3</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="course-detail-module.html">جزئیات نسخه
                                                4</a></li>
                                        <li> <a class="dropdown-item" href="course-video-player.html">جزئیات نسخه
                                                5</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        ...
                                        <li>
                                            <p class="dropdown-item mb-0">به زودی</p>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="shop-product-detail.html">جزئیات دوره</a>
                                        </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="forgot-password.html">فراموشی رمز عبور</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="dropdown-submenu dropend">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        ...
                                        <li> <a class="dropdown-item" href="request-access.html">دسترسی رایگان</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="university-admission-form.html">پذیرش</a>
                                        </li>
                                    </ul>
                                </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="accounntMenu" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">داشبورد</a>
                            <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                                <!-- Dropdown submenu -->
                                <li class="dropdown-submenu dropend">
                                    <a class="dropdown-item dropdown-toggle" href="#"><i
                                            class="fas fa-user-tie fa-fw me-1"></i>مدرس</a>
                                    <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                                        <li> <a class="dropdown-item" href="instructor-dashboard.html"><i
                                                    class="bi bi-grid-fill fa-fw me-1"></i>داشبورد</a> </li>
                                        <li> <a class="dropdown-item" href="instructor-manage-course.html"><i
                                                    class="bi bi-basket-fill fa-fw me-1"></i>لیست دوره ها</a> </li>
                                        <li> <a class="dropdown-item" href="instructor-create-course.html"><i
                                                    class="bi bi-file-earmark-plus-fill fa-fw me-1"></i>ثبت دوره
                                                جدید</a> </li>
                                        <li> <a class="dropdown-item" href="course-added.html"><i
                                                    class="bi bi-file-check-fill fa-fw me-1"></i>دوره اضافه شد!</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="instructor-quiz.html"><i
                                                    class="bi bi-question-diamond fa-fw me-1"></i>امتحانات</a> </li>
                                        <li> <a class="dropdown-item" href="instructor-earning.html"><i
                                                    class="fas fa-chart-line fa-fw me-1"></i>آنالیز و تحلیل درآمد</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="instructor-studentlist.html"><i
                                                    class="fas fa-user-graduate fa-fw me-1"></i>لیست دانشجویان</a>
                                        </li>
                                        <li> <a class="dropdown-item" href="instructor-order.html"><i
                                                    class="bi bi-cart-check-fill fa-fw me-1"></i>لیست سفارشات</a> </li>
                                        <li> <a class="dropdown-item" href="instructor-review.html"><i
                                                    class="bi bi-star-fill fa-fw me-1"></i>دیدگاه ها</a> </li>
                                        <li> <a class="dropdown-item" href="instructor-payout.html"><i
                                                    class="fas fa-wallet fa-fw me-1"></i>درآمدها</a> </li>
                                    </ul>
                                </li>
                                ...
                                <div class="row p-4 g-4">
                                    ...
                                    <div class="col-xl-6 col-xxl-3">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li> <a class="dropdown-item" href="#">استراتژی تولید محتوا</a>
                                            </li>
                                    ...
                                    <div class="col-xl-6 col-xxl-3">
                                        ...
                                        <div
                                            ...
                                            <p class="mb-0 small text-truncate-2">با تولید سادگی نامفهوم از صنعت چاپ و
                                    ...
                                    <div class="col-xl-6 col-xxl-3">
                                        ...
                                        <div class="d-flex mb-4 position-relative">
                                            ...
                                            <div class="ms-2">
                                                <a class="stretched-link h6 mb-0" href="#">مدیر توسعه کسب و کار
                                                    (BDE)</a>
                                                <p class="mb-0 small">بدون پیش نیاز</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex mb-4 position-relative">
                                            ...
                                            <div class="ms-2">
                                                <a class="stretched-link h6 mb-0" href="#">بازاریابی شبکه های
                                                    اجتماعی فیس بوک</a>
                                                <p class="mb-0 small">مشاوره تخصصی</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex mb-4 position-relative">
                                            ...
                                            <div class="ms-2">
                                                <a class="stretched-link h6 mb-0" href="#">طراحی گرافیکی
                                                    خلاقانه</a>
                                                <p class="mb-0 small">بدون پیش نیاز</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3"
                                            ...
                                            <!-- Info -->
                                            کلاس رشد شخصیت از دقیقه 14 شروع می شود، همین حالا <a href="#"
                                                class="alert-link">ثبت نام</a> کنید
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <main>
        <!-- =======================
Main Banner START -->
        <section class="section position-relative overflow-hidden pt-5 pt-lg-3">
            <!-- SVG START -->
            ...
            <div class="container">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0">
                        ...
                        <!-- Content -->
                        <p class="my-4">بازار آنلاین آموزش و یادگیری با بیش از 5K دوره و 10 میلیون دانشجو. توسط
                            متخصصان آموزش داده می شود تا به شما در کسب مهارت های جدید کمک کند.</p>

                        <!-- Info -->
                        <ul class="list-inline position-relative justify-content-center justify-content-lg-start mb-4">
                            <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>مدرس مجرب
                            </li>
                            <li class="list-inline-item me-2"> <i class="bi bi-patch-check-fill h6 me-1"></i>ارائه
                                مدرک</li>
                        ...
                        <div
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-start ms-3">
                                    <h6 class="mb-0 text-white">تبریک میگم!<span class="ms-4"><i
...
Main Banner END -->
        ...
        <!-- =======================
Counter START -->
        <section class="section py-0 py-xl-5">
            <div class="container">
                <div class="row g-4">
                    <!-- Counter item -->
            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col-lg-8 mx-auto text-center">
                        ...
                        <p class="mb-0">هر موضوعی را در هر زمان مطالعه کنید. هزاران دوره آموزشی را با کمترین قیمت
                            جستجو کنید!</p>
                    </div>
                </div>
                ...
                <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab"
                    ...
                    <li class="nav-item me-2 me-sm-5">
                        <button class="nav-link mb-2 mb-md-0 active" id="course-pills-tab-1" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-1" aria-selected="false">طراحی وب</button>
                    </li>
                    <!-- Tab item -->
                    <li class="nav-item me-2 me-sm-5">
                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-2" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-2" aria-selected="false">برنامه نویسی</button>
                    </li>
                    <!-- Tab item -->
                    <li class="nav-item me-2 me-sm-5">
                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-3" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-3" aria-selected="false">طراحی گرافیکی</button>
                    </li>
                    <!-- Tab item -->
                    <li class="nav-item me-2 me-sm-5">
                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-4" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-4" aria-selected="false">دیجیتال مارکتنیگ</button>
                    </li>
                    <!-- Tab item -->
                    <li class="nav-item me-2 me-sm-5">
                        <button class="nav-link mb-2 mb-md-0" id="course-pills-tab-5" data-bs-toggle="pill"
                            ...
                            aria-controls="course-pills-tabs-5" aria-selected="false">بازار مالی</button>
                    </li>
                </ul>
                <!-- Tabs END -->
                    ...
                    <div class="tab-pane fade show active" id="course-pills-tabs-1" role="tabpanel"
                        ...
                        <div class="row g-4">
                                ...
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            <a href="#" class="badge bg-purple bg-opacity-10 text-purple">همه
                                                سطح</a>
                                            <a href="#" class="h6 mb-0"><i class="far fa-heart"></i></a>
                                        </div>
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="#">آموزش Sketch</a></h5>
                                        <p class="mb-2 text-truncate-2">با تولید سادگی نامفهوم از صنعت چاپ و با
                                            استفاده از طراحان گرافیک</p>
                                        <!-- Rating star -->
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>12دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>15 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between ">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>9ساعت</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>65 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>5دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>32 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/07.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="#"> آموزش React-Native</a>
                                        </h5>
                                        <p class="mb-2 text-truncate-2">با تولید سادگی نامفهوم از صنعت چاپ و با
                                            استفاده از طراحان گرافیک</p>
                                        <!-- Rating star -->
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>18دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>99 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>15دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>68 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/12.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <p class="text-truncate-2 mb-2">با تولید سادگی نامفهوم از صنعت چاپ و با
                                            استفاده از طراحان گرافیک</p>
                                        <!-- Rating star -->
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item me-0 small"><i
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>36دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>72 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/04.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <p class="mb-2">با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان
                                            گرافیک</p>
                                        <!-- Rating star -->
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item me-0 small"><i
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>6ساعت</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>82 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/09.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>35دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>89 دوره</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="course-pills-tabs-2" role="tabpanel"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/05.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>10ساعت</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>26 دوره</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>9ساعت</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>42 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>18دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>99 دوره</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>35دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>89 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/10.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between mt-2">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>25دقیقه</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>38 دوره</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/13.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="card-footer pt-0 pb-3">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>21ساعت</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>30 ویدیو</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="course-pills-tabs-4" role="tabpanel"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="assets/images/courses/4by3/01.jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                ...
                                <div class="col-11 mx-auto position-relative">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-7">
                                            ...
                                            <p class="text-white mb-3 mb-lg-0">ارائه راهکارها و شرایط سخت تایپ به
...
Trending courses START -->
        <section class="section pb-5 pt-0 pt-lg-5">
            <div class="container">
                <!-- Title -->
                <div class="row mb-4">
                    <div class="col-lg-8 mx-auto text-center">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">
                                            <span class="hstack gap-2">
                                                <a href="#" class="badge bg-primary bg-opacity-10 text-primary">طراحی
                                                    وب</a>
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="#">آموزش ساخت شبکه اجتماعی
                                                با MERN</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">مهرداد
                                                        نوروزی</a></p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                                                ...
                                                <a href="#" class="btn btn-sm btn-success-soft item-show-hover"><i
                                                        class="fas fa-shopping-cart me-2"></i>افزودن به سبد</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="#">دوره بازاریابی دیجیتال
                                                برای مبتدیان</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <div class="hstack gap-2">
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">علی صالحی</a>
                                                </p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">
                                            <span class="hstack gap-2">
                                                <a href="#" class="badge bg-primary bg-opacity-10 text-primary">برنامه
                                                    نویسی</a>
                                                <a href="#" class="badge text-bg-dark">مقدماتی</a>
                                            </span>
                                            <a href="#" class="h6 fw-light mb-0"><i class="far fa-bookmark"></i></a>
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="#">آموزش ساخت سایت خبری با
                                                لاراول</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <div class="hstack gap-2">
                                        ...
                                        <div class="hstack gap-3">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>24ساعت</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>55 ویدیو</span>
                                        </div>
                                    </div>
                                    <!-- Card footer -->
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">الهام
                                                        نصرتی</a></p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="#">آموزش مقدماتی کتابخانه
                                                Pygame</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <div class="hstack gap-2">
                                        ...
                                        <div class="hstack gap-3">
                                            <span class="h6 fw-light mb-0"><i
                                                    class="far fa-clock text-danger me-2"></i>9ساعت</span>
                                            <span class="h6 fw-light mb-0"><i
                                                    class="fas fa-table text-orange me-2"></i>21 ویدیو</span>
                                        </div>
                                    </div>
                                    <!-- Card footer -->
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="#" class="h6 fw-light mb-0">زهرا حیدری</a>
                                                </p>
                                            </div>
                                            <!-- Price -->
                                            <div>
            ...
            <div class="container">
                <div class="row g-4 g-lg-5 align-items-center">
                                ...
                                <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                    ...
                                    <blockquote>
                                        <p>
                                            ...
                                            با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی
                        ...
                        <div class="row mt-5 mt-xl-0">
                            ...
                            <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                                ...
                                <figure
                                    ...
                                    <svg style="transform: scale(-1,1)" enable-background="new 0 0 160.7 159.8"
                                        height="180px">
                                        <path
                    ...
                    <div class="col-xl-5 order-1 text-center text-xl-start">
                        ...
                        <p>با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3">
                    ...
                    <p class="my-3">شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی
                ...
                <div class="container px-0">
                    <div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-md-left">
                        ...
                        <div class="text-primary-hover"> ارائه شده در سایت <a href="https://www.rtl-theme.com/"
                                target="_blank" class="text-body">راست چین</a></div>
                        <!-- copyright links-->
                                    ...
                                    <div class="dropup mt-0 text-center text-sm-end">
                                        ...
                                        <ul class="dropdown-menu min-w-auto" aria-labelledby="languageSwitcher">
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="assets/images/flags/uk.svg" alt="">فارسی</a></li>
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="assets/images/flags/gr.svg" alt="">انگلیسی </a></li>
                                            <li><a class="dropdown-item me-4" href="#"><img class="fa-fw me-2"
                                                        src="assets/images/flags/sp.svg" alt="">فرانسوی</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="list-inline-item"><a class="nav-link" href="#">شرایط استفاده</a>
                                </li>
                                <li class="list-inline-item"><a class="nav-link pe-0" href="#">قوانین
                                        سایت</a></li>
                            </ul>
                        </div>
                    </div>
